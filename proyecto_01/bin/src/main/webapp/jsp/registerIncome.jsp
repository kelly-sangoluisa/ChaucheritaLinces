...
<body>
    <div class="container">
        <h1>Nuevo Ingreso</h1>
        <form action="ContabilidadController?ruta=registerIncome&cuentaId=${cuenta.idAccount}" method="post">
            ...
            <input type="text" id="destino" name="destino" value="${cuenta.nameAccount}" readonly>
